...
CREATE TABLE `notification` (
  ...
  CONSTRAINT `FKjsqpq32j3cp7sbi81on7xo3jg` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
...
INSERT INTO `notification` VALUES (1,'The price: $155.0was reached at 2019-10-16 10:47:44.0','2019-10-16 21:32:32',1,0);
